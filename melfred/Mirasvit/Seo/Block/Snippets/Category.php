...
class Category extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Mirasvit\Seo\Helper\Data $seoDataHelper
    ...
    public function __construct(
        ...
        \Mirasvit\Seo\Helper\Data                        $seoDataHelper,
        array $data = []
    ) {
        ...
        $this->seoDataHelper = $seoDataHelper;
    ...
    {
        return $this->seoDataHelper->getFullActionCode();
    }
    ...
    public function categorySnippetsFilter()
    {
        if ($this->getConfig()->getCategoryRichSnippets(
            ...
            if (!$this->registry->registry(CurrentPageProductsInterface::PRODUCT_COLLECTION)) {
    ...
    {
        return SnippetsTrait::prepareSnippet($this->registry->registry('current_category')->getName());
    }
    ...
    public function getCurrentPageProductCount()
    {
        ...
        if ($categoryProduct = $this->registry->registry(CurrentPageProductsInterface::PRODUCT_COLLECTION)) {
    ...
    {
        $actions = ['catalog_category_view', 'amshopby_index_index'];

        return in_array($this->getFullActionCode(), $actions);
    }
}
