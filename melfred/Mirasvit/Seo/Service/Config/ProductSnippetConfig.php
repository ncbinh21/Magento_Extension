...
class ProductSnippetConfig implements ProductSnippetConfigInterface
{
    ...
    {
        return $this->scopeConfig->getValue('seo_snippets/product_snippets/rich_snippets_delete_wrong');
    }
    ...
    {
        return $this->scopeConfig->getValue('seo_snippets/product_snippets/rich_snippets_individual_reviews_enabled');
    }
