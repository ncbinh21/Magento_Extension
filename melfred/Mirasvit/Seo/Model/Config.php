...
class Config
{
    ...
    {
        return $this->scopeConfig->getValue('seo/general/canonical_store_without_store_code',
    ...
    {
        return $this->scopeConfig->getValue('seo/general/crossdomain_prefer_https',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @return int
     */
    public function isDeleteWrongRichSnippetsForHomePage($store)
    {
        return $this->scopeConfig->getValue(
            'seo_snippets/home_page_snippets/rich_snippets_delete_wrong_for_home_page',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @return int
     */
    public function getTwitterCard($store)
    {
        return $this->scopeConfig->getValue(
            'seo_snippets/twitter/get_twitter_card',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE,
            $store
        );
    }
    ...
    {
        return $this->scopeConfig->getValue('seo_snippets/twitter/twitter_user');
    }
