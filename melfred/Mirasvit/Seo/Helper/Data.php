...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    public function checkTempalateRule($isProduct,
                                       $isCategory,
                                       $isFilter,
                                       $info = false,
                                       $product = false,
        ...
        if ($isProduct) {
            // echo 'PRODUCTS_RULE';
            if (!$this->registry->registry('current_product') && !$product) {
                return false;
            }
            ...
            $productId = ($product) ? $product->getId() : $this->registry->registry('current_product')->getId();
