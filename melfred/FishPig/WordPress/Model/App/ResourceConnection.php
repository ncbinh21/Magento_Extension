...
class ResourceConnection
{
	...
	**/
	 ...
	 * @var 
	**/
	public function __construct(ConnectionFactory $connectionFactory, \Psr\Log\LoggerInterface $logger)
	{
	...
	public function connect(array $config)
	{
		try {
            ...
            \FishPig\WordPress\Model\App\Integration\Exception::throwException(
				'Error connecting to the WordPress database. Check the WordPress database details.',
				$e->getMessage()
			);
		}
