...
namespace Forix\ShopbyBrand\Observer\Admin;
...
class OptionFormBuildAfter implements ObserverInterface
{
    ...
    private function addProductListFieldset(\Magento\Framework\Data\Form $form, OptionSetting $model)
    {
		...
		$productListFieldset->addField(
			...
			'editor',
			[
				'name' => 'rig_description',
				'label' => __('Rig Description'),
				'title' => __('Rig Description'),
				'wysiwyg' => true,
				'config' => $this->_wysiwygConfig->getConfig(['add_images'=>false])
			]
		);
        ...
        $productListFieldset->addField('rig_manufacture',
            'select',
            [
                'name' => 'rig_manufacture',
