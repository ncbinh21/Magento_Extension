...
class Edit extends \Forix\Guide\Controller\Adminhtml\Download
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('forix_guide_download', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Download') : __('New Download'),
            $id ? __('Edit Download') : __('New Download')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Downloads'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Download'));
        return $resultPage;
    }
}
