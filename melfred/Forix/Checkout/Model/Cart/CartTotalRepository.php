...
namespace Forix\Checkout\Model\Cart;
...
class CartTotalRepository implements CartTotalRepositoryInterface
{
    ...
    public function get($cartId)
    {
        ...
        if (isset($addressTotalsData[ExtensibleDataInterface::EXTENSION_ATTRIBUTES_KEY]) &&
            $addressTotalsData[ExtensibleDataInterface::EXTENSION_ATTRIBUTES_KEY] instanceof \Magento\Quote\Api\Data\AddressExtension) {
