...
class Edit extends \Forix\Media\Controller\Adminhtml\Video
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('forix_media_video', $model);
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Video'));
        return $resultPage;
    }
}
