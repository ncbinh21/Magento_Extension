...
var IASSpinnerExtension = window.IASSpinnerExtension = function(options) {
  ...
  this.showSpinner = function() {
    ...
    jQuery('#product-loadmore').html($spinner);
    $spinner.fadeIn();
  };
  ...
  this.removeSpinner = function() {
    if (this.hasSpinner()) {
      if(this.getSpinner().parent().attr('id') == 'product-loadmore') {
        this.getSpinner().parent().remove();
      } else {
