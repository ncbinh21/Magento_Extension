...
class Slider extends \Magento\Framework\Model\AbstractModel
{
    ...
    const STYLESLIDE_CUSTOM = 11;
    const STYLESLIDE_BANNER = 12;
     ...
     * @param \Forix\Bannerslider\Model\ResourceModel\Slider                   $resource
     * @param \Forix\Bannerslider\Model\ResourceModel\Slider\Collection        $resourceCollection
     */
    public function __construct(
        \Magento\Framework\Model\Context $context,
        \Magento\Framework\Registry $registry,
        \Forix\Bannerslider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
        \Forix\Bannerslider\Model\ResourceModel\Slider $resource,
        \Forix\Bannerslider\Model\ResourceModel\Slider\Collection $resourceCollection
    ) {
        parent::__construct(
            $context,
            $registry,
