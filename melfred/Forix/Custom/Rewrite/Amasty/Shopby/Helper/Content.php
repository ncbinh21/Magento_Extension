...
namespace Forix\Custom\Rewrite\Amasty\Shopby\Helper;
...
class Content extends \Amasty\Shopby\Helper\Content
{
    /**
     * @var  Category
     */
    ...
    public function __construct(
        ...
        parent::__construct($context, $layerResolver, $filterList, $storeManager, $registry, $pageConfig, $optionHelper, $amshopbyRequest, $dataHelper);
    ...
    public function setCategoryData(CategoryModel $category)
    {
        ...
        if($this->category->getForixProductListTemplate() != 'category_ground_condition_template') {
            $data['title'] = [];
        }
