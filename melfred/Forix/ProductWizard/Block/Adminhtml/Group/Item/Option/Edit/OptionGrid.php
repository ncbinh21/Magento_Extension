...
class OptionGrid extends \Magento\Backend\Block\Template
{
    /**
     * Block template
     *
     * @var string
     */
    protected $_template = 'group/item/assign_options.phtml';
    ...
    public function getBlockGrid()
    {
        if (null === $this->blockGrid) {
            $this->blockGrid = $this->getLayout()->createBlock(
                \Forix\ProductWizard\Block\Adminhtml\Group\Item\Option\Edit\Option::class,
                'group.item.options.grid'
            );
        }
