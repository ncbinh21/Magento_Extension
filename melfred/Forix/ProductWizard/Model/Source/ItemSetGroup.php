...
class ItemSetGroup implements SourceInterface, OptionSourceInterface
{
    /**
     * @var
     */
    ...
    protected $collectionWizardFactory;

    public function __construct(
        \Forix\ProductWizard\Model\ResourceModel\Wizard\CollectionFactory $collectionWizardFactory,
        \Forix\ProductWizard\Model\WizardRepository $wizardRepository,
        \Magento\Framework\Registry $coreRegistry
    )
    {
        $this->collectionWizardFactory = $collectionWizardFactory;
    ...
    public function getOptionArray()
    {
        try {
            ...
            if ($currentOption && $wizardId = $currentOption->getWizardId()) {
                ...
                $wizard = $this->collectionWizardFactory->create()->getFirstItem();
