...
class GridDependOn extends \Forix\ProductWizard\Controller\Adminhtml\GroupItemOption
{
    /**
    ...
    public function execute()
    {
        ...
        return $resultRaw->setContents(
            $this->layoutFactory->create()->createBlock(
                \Forix\ProductWizard\Block\Adminhtml\Group\Item\Option\Edit\WizardOptionDependOn::class,
