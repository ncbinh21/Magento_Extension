...
class Edit extends \Forix\ProductWizard\Controller\Adminhtml\Group
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Forix\ProductWizard\Model\Group');
        ...
        $this->_coreRegistry->register('forix_productwizard_group', $model);
