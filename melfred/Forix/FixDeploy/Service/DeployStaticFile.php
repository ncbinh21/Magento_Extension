...
class DeployStaticFile extends \Magento\Deploy\Service\DeployStaticFile
{
	/**
	 * @var Filesystem
	 */
	...
	public function __construct(
		...
		parent::__construct($filesystem, $assetRepo, $assetPublisher, $fileNameResolver, $minification);
