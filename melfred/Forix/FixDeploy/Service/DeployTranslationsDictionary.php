 ...
 */
namespace Forix\FixDeploy\Service;
 ...
 */
class DeployTranslationsDictionary extends \Magento\Deploy\Service\DeployTranslationsDictionary
{
    /**
    ...
    public function __construct(
    	...
    	parent::__construct($jsTranslationConfig, $deployStaticFile, $state, $logger);
