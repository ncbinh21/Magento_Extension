...
namespace Forix\Company\Rewrite\Controller\Account;
...
class CreatePost extends \Magento\Company\Controller\Account\CreatePost
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $userContext, $logger, $objectHelper, $formKeyValidator, $captchaValidator, $customerAccountManagement, $customerDataFactory, $companyCreateSession);
    }
    ...
    public function execute()
    {
        ...
        try {
            ...
            if(isset($customerData['company']) && isset($customerData['company']['country_id'])) {
                $customer->setCustomAttribute('country_name', $customerData['company']['country_id']);
            }
            if(isset($customerData['company']) && isset($customerData['company']['company_name'])) {
                $customer->setCustomAttribute('company_title', $customerData['company']['company_name']);
            }
...
//            $resultRedirect->setPath('*/account/index');
            $resultRedirect->setPath('create-company-acc-success');
//            if(isset($_COOKIE['redirect_checkout']) && $_COOKIE['redirect_checkout'] == 1) {
//                $resultRedirect->setPath('create-company-acc-success');
//            }
