...
class Edit extends \Forix\NetTerm\Controller\Adminhtml\Netterm
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('forix_netterm_netterm', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Net Terms') : __('New Net Terms'),
            $id ? __('Edit Net Terms') : __('New Net Terms')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Net Terms'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Net Terms'));
        return $resultPage;
    }
}
