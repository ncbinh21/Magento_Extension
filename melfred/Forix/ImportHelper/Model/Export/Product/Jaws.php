...
class Jaws extends \Forix\ImportHelper\Model\Export\AbstractProduct
{
    ...
    protected function addFieldToFilter($collection)
    {
        ...
        $collection->addFieldToFilter('file_name', ['like' => '%Jaws.csv%']);
        return $collection;
    }
    ...
    protected function getColumnToSelect()
    {
        return [
            ...
            "mb_relation_attributes" => "relation_attributes",
