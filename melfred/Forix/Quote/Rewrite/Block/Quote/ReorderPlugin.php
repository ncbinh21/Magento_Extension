...
class ReorderPlugin extends \Magento\NegotiableQuote\Plugin\Sales\Controller\Order\ReorderPlugin
{
	/**
	 * @var Cart
	 */
	...
	public function aroundExecute(
		...
		// set registry to add option in cart
		$this->registry->register("reorder", $order);
