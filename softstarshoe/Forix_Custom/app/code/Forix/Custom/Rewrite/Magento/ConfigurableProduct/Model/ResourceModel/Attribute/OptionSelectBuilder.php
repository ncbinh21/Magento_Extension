<?php
namespace Forix\Custom\Rewrite\Magento\ConfigurableProduct\Model\ResourceModel\Attribute;
 ...
 */
class OptionSelectBuilder implements \Magento\ConfigurableProduct\Model\ResourceModel\Attribute\OptionSelectBuilderInterface
{
    /**
     ...
     */
    public function __construct(Attribute $attributeResource, \Magento\ConfigurableProduct\Model\ResourceModel\Attribute\OptionProvider $attributeOptionProvider)
    {
    ...
    public function getSelect(AbstractAttribute $superAttribute, int $productId, ScopeInterface $scope)
    {
        $select = $this->attributeResource->getConnection()->select()->from(
            ...
            )->order('attribute_opt.sort_order ASC');
