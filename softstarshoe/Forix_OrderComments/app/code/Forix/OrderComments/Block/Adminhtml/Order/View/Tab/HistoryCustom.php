...
class HistoryCustom extends \Magento\Sales\Block\Adminhtml\Order\View\Tab\History
{
     ...
     * @return array
     */
    protected function _prepareHistoryItemList($label, $notified, $created, $comment = '', $orderNote = '')
    {
        return ['title' => $label, 'notified' => $notified,  'comment' => $comment, 'created_at' => $created, 'order_note' => $orderNote];
    }
}