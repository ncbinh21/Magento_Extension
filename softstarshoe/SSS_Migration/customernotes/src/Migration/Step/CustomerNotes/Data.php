<?php
namespace Migration\Step\CustomerNotes;
...
class Data extends \Migration\Step\DatabaseStage implements StageInterface
{
    ...
    public function __construct(
        ...
        $this->map = $mapFactory->create('forix_customernotes_map_file');
        $this->progress = $progress;
        $this->readerGroups = $groupsFactory->create('forix_customernotes_groups_file');
        $this->logger = $logger;
        $this->helper = $helper;
        $this->config = $config;
