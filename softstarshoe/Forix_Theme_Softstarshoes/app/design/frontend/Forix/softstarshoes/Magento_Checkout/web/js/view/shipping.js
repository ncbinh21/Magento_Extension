...
define([
    ...
    return Component.extend({
        ...
        getDataProduct: function () {
            return window.checkoutConfig.totalsData.items;
        },

        getImageProduct: function (id) {
            return window.checkoutConfig.imageData[id].src;
        },

        removeProductRestriction: function () {
            ...
            for (var i = 0; i < listItems.length; i++) {
                if (listItems[i].extension_attributes.product_restriction == '1') {
                    productRestriction.push(listItems[i].item_id);
                }
            }
            $.ajax({
        ...
        checkRestriction: function () {
            ...
            if (getQuote.shippingAddress._latestValue.countryId != 'US' && getQuote.shippingAddress._latestValue.countryId != 'CA') {
