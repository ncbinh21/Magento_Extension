...
define([
    ...
    $.widget('mage.orderReview', $.orange35.imageConstructorMini, {
        options: {
        ...
        _create: function () {
            ...
            this.element.on('click', this.options.orderReviewSubmitSelector, $.proxy(this._submitOrder, this))
                ...
                ).on('change', '#shipping-method', _this.applyLayersToItems()).find(this.options.updateOrderSelector).on('click', $.proxy(this._updateOrderHandler, this)).end()
         ...
         */
        _submitUpdateOrder: function (url, resultId, _this) {
