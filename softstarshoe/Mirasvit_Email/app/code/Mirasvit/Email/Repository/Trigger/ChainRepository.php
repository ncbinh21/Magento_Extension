...
use Mirasvit\Email\Api\Data\TriggerChainInterfaceFactory;
...
class ChainRepository implements ChainRepositoryInterface
{
    ...
    /**
     * @var TriggerChainInterfaceFactory
     */
    ...
    public function __construct(
        ...
        TriggerChainInterfaceFactory $chainFactory,
    ...
    public function delete(TriggerChainInterface $model)
    {
        ...
        $queueToDelete->addFieldToFilter(QueueInterface::STATUS, QueueInterface::STATUS_PENDING)
            ->addFieldToFilter(TriggerChainInterface::ID, $model->getId());
