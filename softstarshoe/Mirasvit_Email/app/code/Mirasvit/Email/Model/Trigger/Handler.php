...
class Handler
{
     ...
     * @return $this
     */
    protected function handleEvent(TriggerInterface $trigger, EventInterface $event)
    {
     ...
     *
     * @param TriggerInterface      $trigger
     * @param TriggerChainInterface $chain
     * @param EventInterface        $event
     *
     * @return bool|QueueInterface
     */
    private function enqueue(TriggerInterface $trigger, TriggerChainInterface $chain, EventInterface $event)
    {
    ...
    private function getQueueCollection($triggerId, $chainId, $uniqueKey, $gmtScheduledAt)
    {
        ...
        $queueCollection->addFieldToFilter(TriggerInterface::ID, $triggerId)
            ->addFieldToFilter(TriggerChainInterface::ID, $chainId)
