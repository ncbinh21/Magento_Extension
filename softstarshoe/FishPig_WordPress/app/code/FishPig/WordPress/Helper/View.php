...
class View extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function applyPageConfigData($pageConfig, $entity, $postList = null)
	{
		...
		if(!$postList == 'list') {
		    ...
		    if(!$entity->getMetaDescription()) {
                $pageConfig->setDescription('Stay up to date with the latest news from Softstar, including new shoe styles, foot health tips and our fun workshop adventures.');
            }
        }
