...
{
    //const LIST_MEDIA_NAME =['image', 'image_thumb', 'tablet', 'tablet_thumb', 'phone', 'phone_thumb'];
    const BASE_MEDIA_PATH = 'forix/bannerslider/images';
     ...
     * value factory.
     *
     * @var \Forix\Bannerslider\Model\ValueFactory
     */
     ...
     * @param \Forix\Bannerslider\Model\ResourceModel\Banner                   $resource
     * @param \Forix\Bannerslider\Model\ResourceModel\Banner\Collection        $resourceCollection
    ...
    public function __construct(
        ...
        \Forix\Bannerslider\Model\ResourceModel\Banner $resource,
        \Forix\Bannerslider\Model\ResourceModel\Banner\Collection $resourceCollection,
        \Forix\Bannerslider\Model\BannerFactory $bannerFactory,
        \Forix\Bannerslider\Model\ValueFactory $valueFactory,
