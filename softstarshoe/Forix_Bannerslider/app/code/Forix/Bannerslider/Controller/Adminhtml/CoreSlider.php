 ...
 */
abstract class CoreSlider extends \Forix\Bannerslider\Controller\Adminhtml\AbstractAction
{
    /**
    ...
    {
        return $this->_authorization->isAllowed('Forix_Bannerslider::bannerslider_coreslider');
    }
}
