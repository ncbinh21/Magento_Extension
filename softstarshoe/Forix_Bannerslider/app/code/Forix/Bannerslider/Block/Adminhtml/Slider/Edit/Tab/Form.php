 ...
 * Time: 1:24 PM
 */
namespace Forix\Bannerslider\Block\Adminhtml\Slider\Edit\Tab;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * @param \Forix\Bannerslider\Helper\Data                                    $bannersliderHelper [description]
    ...
    protected function _prepareForm()
    {
        ...
        $fieldMaps['slider_auto_play'] = $fieldset->addField(
            'slider_auto_play',
            'select',
            [
                'label' => __('Auto Play'),
        ...
        $fieldMaps['sort_type'] = $fieldset->addField(
            ...
            [
                ...
                'values' => [
                    [
                        'value' => \Forix\Bannerslider\Model\Slider::SORT_TYPE_RANDOM,
                        'label' => __('Random'),
                    ],
                    [
                        'value' => \Forix\Bannerslider\Model\Slider::SORT_TYPE_ORDERLY,
                        'label' => __('Orderly'),
                    ],
                ],
            ]
        ...
        $positionImage = [];
        for ($i = 1; $i <= 5; ++$i) {
            $positionImage[] = $this->getViewFileUrl("Forix_Bannerslider::images/position/bannerslider-ex{$i}.png");
        }
        ...
        $fieldMaps['cms_ids'] = $fieldset->addField(
            'cms_ids',
            'multiselect',
            [
                'label' => __('CMS Page'),
                'name' => 'cms_ids',
                'values' => $this->_bannersliderHelper->getCmsPagesArray(),
            ]
        );
    ...
    public function getMappingFieldDependence()
    {
        return [
            ...
            [
                'fieldName' => ['sort_type', 'animationB', 'slider_speed', 'slider_auto_play'],
                'fieldNameFrom' => 'style_slide',
                'refField' => '7',
            ],
        ];
