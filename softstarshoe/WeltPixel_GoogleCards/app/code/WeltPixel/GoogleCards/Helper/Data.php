...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getFacebookAppId($storeId = 0) {
        if ($storeId) {
            return $this->scopeConfig->getValue('weltpixel_schemas/facebook_opengraph/app_id', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
        } else {
            return $this->_schemasOptions['facebook_opengraph']['app_id'];
        }
    }
     ...
     * @return mixed
     */
    public function getRichSnippetPrice($storeId = 0) {
        if ($storeId) {
            return $this->scopeConfig->getValue('weltpixel_schemas/rich_snippet/price', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
        } else {
            return $this->_cardsOptions['rich_snippet']['price'];
        }
    }
    ...
    public function getTwitterCardsPrice($storeId = 0) {
        if ($storeId) {
            return $this->scopeConfig->getValue('weltpixel_schemas/twitter_cards/price', \Magento\Store\Model\ScopeInterface::SCOPE_STORE, $storeId);
        } else {
            return $this->_schemasOptions['twitter_cards']['price'];
        }
    }
    ...
    public function getFacebookOpenGraphPrice($storeId = 0) {
        if ($storeId) {
            ...
            return $this->_schemasOptions['facebook_opengraph']['price'];
        }
    }
}
